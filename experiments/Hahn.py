...
class Hahn_Meas:
    ...
    def Hahn(
        ...
        with InstrumentGateway() as gw, DataSource(datasetName) as HahnData:

            print('Hahn PARAMETERS')
            ...
            for tau in self.tau_list:
                seqs.append(Pulses(gw).HAHN(int(tau), clock_time, init_time, readout_time, laser_lag, singlet_decay, pi_half_time, tau_max))
            ...
            with NIDAQ() as mynidaq:
                ...
                x_init_position = 3.4194
                y_init_position = 3.1298
                z_init_position = 7.7527
