...
import experiments.TwoMeasMWT1 as TwoMeasMWT1


class TwoMeasMWT1_Widget(QtWidgets.QWidget):
    
    def __init__(self):
        super().__init__()

        self.setWindowTitle('Two Meas MW T1')

        self.params_widget = ParamsWidget({

            'datasetName': {
                'display_text': 'Dataset Name',
                'widget': QtWidgets.QLineEdit('Two Meas MW T1'),
            },
    ...
    def runClicked(self):
        ...
        TwoMeasMWT1Meas = TwoMeasMWT1.Two_Meas_MW_T1_Meas()

        # run the sweep function in a new thread
        self.sweepProc.run(
            TwoMeasMWT1Meas.TwoMeasMWT1,
...
class TwoMeasMWT1PlotWidget(LinePlotWidget):

    def __init__(self):
        title = 'Two Meas MW T1'
        super().__init__(title=title, xlabel='Taus (us)', ylabel='AU')


    def setup(self):
        self.sink = DataSink('Two Meas MW T1')
        self.sink.__enter__() 
    ...
    def update(self):
        ...
        self.set_data('M_plus', self.sink.datasets['taus']/1000, self.sink.datasets['M_plus'])
        self.set_data('M_minus', self.sink.datasets['taus']/1000, self.sink.datasets['M_minus'])
