...
import experiments.MWT1 as MWT1


class MWT1_Widget(QtWidgets.QWidget):
    
    def __init__(self):
        super().__init__()

        self.setWindowTitle('MW T1')

        self.params_widget = ParamsWidget({

            'datasetName': {
                'display_text': 'Dataset Name',
                'widget': QtWidgets.QLineEdit('MW T1'),
            },
...
class MWT1PlotWidget(LinePlotWidget):
