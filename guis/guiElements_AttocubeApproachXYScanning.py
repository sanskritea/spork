...
import experiments.AttocubeApproachXYScanning as AttocubeApproachXYScanning
import numpy as np


class AttocubeApproachXYScanning_Widget(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.params_widget = ParamsWidget({
            'datasetName': {
                ...
                'widget': QtWidgets.QLineEdit('AttocubeApproachXYScanningData'),
            },
            ...
            'z_init_voltage': {
                'display_text': 'MFLI AO/Z Init Voltage',
                'widget': SpinBox(
                    value=-0.1,
                    dec=True,
                ),
            ...
            'z_final_voltage': {
                'display_text': 'MFLI AO/Z Final Voltage',
                'widget': SpinBox(
                    value=8,
                    dec=True,
                ),
    ...
    def runClicked(self):
        ...
        self.sweepProc.run(
            ...
            self.params_widget.z_init_voltage, 
            self.params_widget.z_final_voltage,
            self.params_widget.z_voltage_steps,
...
class AttocubeApproachXYScanningPlotWidget(HeatMapWidget):
    ...
    def setup(self):
        self.sink = DataSink('AttocubeApproachXYScanningData')
        self.sink.__enter__() 
    ...
    def update(self):
        ...
        self.set_data(self.sink.datasets['yvoltage'], self.sink.datasets['xvoltage'], self.sink.datasets['engagement_voltage'])
