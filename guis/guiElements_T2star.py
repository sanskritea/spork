...
import experiments.T2star as T2star


class T2star_Widget(QtWidgets.QWidget):
    
    def __init__(self):
        super().__init__()

        self.setWindowTitle('T2_star')

        self.params_widget = ParamsWidget({

            'datasetName': {
                'display_text': 'Dataset Name',
                'widget': QtWidgets.QLineEdit('T2_star'),
            },
    ...
    def runClicked(self):
        ...
        T2starMeas = T2star.T2_STAR_Meas()
...
class T2starPlotWidget(LinePlotWidget):
    ...
    def update(self):
        ...
        self.set_data('Difference', tau_list / 1000, [np.mean(self.sink.datasets['BrightCounts'][tau] - self.sink.datasets['DarkCounts'][tau]) for tau in tau_list])
