...
import experiments.NewportXYScanning as NewportXYScanning
import numpy as np


class NewportXYScanning_Widget(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.params_widget = ParamsWidget({
            'datasetName': {
                ...
                'widget': QtWidgets.QLineEdit('NewportXYScanningData'),
            },
...
class NewportXYScanningPlotWidget(HeatMapWidget):

    def __init__(self):
        title = 'XY Scan'
        super().__init__(title=title, btm_label='X position (mm) ', lft_label='Y position (mm)') #TODO: Switch this over to contrast


    def setup(self):
        self.sink = DataSink('NewportXYScanningData')
        self.sink.__enter__() 
