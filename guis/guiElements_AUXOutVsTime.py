...
import experiments.AUXOutVsTime as AUXOutVsTime
from guis.guiElements_general import AutoSaveWidget
from guis.guiElements_general import flexSave

class AUXOutVsTime_Widget(QtWidgets.QWidget):

	def __init__(self):
		super().__init__()

		self.setWindowTitle('AUXOutVsTime')

		self.params_widget = ParamsWidget({
            'datasetname': {
                'display_text': 'Dataset Name',
                'widget': QtWidgets.QLineEdit('AUXOutVsTime'),
            },
	...
	def runClicked(self):
	    ...
	    AUXOutVsTimeMeas = AUXOutVsTime.AUXOutVsTime_Measurement()
...
class AUXOutVsTimePlotWidget(LinePlotWidget):
