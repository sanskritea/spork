...
class NIDAQ_PhotonCounter():
    def __init__(self):
        ...
        self.rawAPDchannel = '/Dev4/PFI5' #ctr3
        self.s1H_s2H_APDchannel = '/Dev4/PFI0' #ctr2
        self.s1H_s2L_APDchannel = '/Dev4/PFI3'#ctr1
        self.s1L_s3H_APDchannel = '/Dev4/PFI8'#ctr0
        self.apdChannelsDict = {2: self.s1H_s2H_APDchannel, 1: self.s1H_s2L_APDchannel,
                                0: self.s1L_s3H_APDchannel, 3: self.rawAPDchannel }
    ...
    def readCtrs_multiRead_intClk(self, acqRate, numSamples:int, ctrChanNums=[0,1,2,3]):
        ...
        with nidaqmx.Task() as dummyClkTask, ExitStack() as stack:
            ...
            for i, ctrChan in enumerate(ctrChans):
                ...
                ctrTask.timing.cfg_samp_clk_timing(acqRate, source='/Dev4/di/SampleClock',samps_per_chan = numSamples)
