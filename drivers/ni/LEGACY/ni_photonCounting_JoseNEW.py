...
class NIDAQ():
    def __init__(self):
        pass
        #self.nothingness = 0 #WTF is this doing here???
    ...
    def read_ctrs_many(self, ctr_channels, period, num_samples):
        ...
        sample_clk_channel = '/Dev1/100MHzTimebase'
        ...
        with nidaqmx.Task() as sample_clk_task, ExitStack() as stack:
            ...
            for ctr_channel in ctr_channels:
                ...
                counter_task.ci_channels.add_ci_count_edges_chan('Dev1/ctr1')
                #counter_task.ci_channels.add_ci_count_edges_chan('\Dev1\ctr1') #TODO: Fix this since it's hardcoding af
                counter_task.ci_channels.physical_channel = ctr_channel
                #print(counter_task.ci_channels.physical_channel) #DEBUG
...
if __name__ == '__main__':
    nidaq = NIDAQ()
    print(nidaq.read_ctrs_single(['Dev1/port0/line11'], 1)) #2nd arg is period #'Dev1/port0/line11'