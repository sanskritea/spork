#TO-DO: Make laser turn on with 5mW unless otherwise specified.
#TO-DO: Currently need to turn laser on programmatically, then turn 
#       laser key off and on again. Modify this behavior
...
class CoboltLaser:
    ...
    def __init__(self, port='COM3', serialnumber=None, baudrate=115200):
    ...
    def __enter__(self):
        self.connect() #connect device here rather than __init__ per new NSpyre standard
        return self
...
# Todo: add other laser inheretence classes for the new lasers and stuff
...
def list_lasers():
    ...
    for port in ports:
        try: 
            with CoboltLaser(port=port.device) as laser:
