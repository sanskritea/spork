...
# Load library
# use cdecl on unix and stdcall on windows (see subfolders for other libraries)
# def ximc_shared_lib():
...
#Simplified load library
library_path = r'C:\Users\adminnd\code\jasper-repo\drivers\standa\StandaLibraries\libximc.dll'
lib = WinDLL(library_path)
