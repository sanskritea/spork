...
import guis.guiElements_PIDOutVsTime as guiElements_PIDOutVsTime
    ...
    main_widget = MainWidget(
        {
            ...
            'PIDOutVsTime': MainWidgetItem(guiElements_PIDOutVsTime, 'PIDOutVsTime_Widget', stretch=(1, 1)),
            ...
            'Plots': {
                ...
                'PID Out VS Time': MainWidgetItem(
                    guiElements_PIDOutVsTime,
                    'PIDOutVsTimePlotWidget',
                    stretch=(100, 100),
                ),
